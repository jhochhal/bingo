...
def _integer(_param1,_param2,_path,_answer,_commands,_constants,_same,_stack):
    pass
...
def _divide(param1,param2,path,answer,commands,constants,same,stack):
    ...
    array2 = commands[param1]
    node2,c2,_ = array2
    if (node2 == 1 or node2 == -1) and (node1 == 1 or node1 == -1):
        if node2 == 1:
            n2 = constants[c2]
        else:
            n2 = c2
        if node1 == 1:
            ...
            n1 = c1
        newAnswer2[0] *= - n2/(n1**2)
        
    else:
        if (node2 == 1 or node2 == -1) and (node1 != 1 and node1 != -1):
            if node2 == 1:
                n2 = constants[c2]
            else:
                n2 = c2
        ...
        elif (node2 != 1 and node2 != -1) and (node1 == 1 or node1 == -1):
            if node1 == 1:
                n1 = constants[c1]
            else:
                n1 = c1
